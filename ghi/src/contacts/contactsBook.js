...
function ContactBook(props) {
    ...
    const sortedList = props.contacts.map(obj => {return {
        "contact_id": obj.id,
                        ...
                        {listGroupsOfN(sortedList,3).map((groupOf3,idx) => {
                            return (
                                <div className={`page bordered-${(idx+1)%2 ? 'right' : 'left'}`}
                                    ...
                                    onClick={e=> (idx+1)%2 ? nextPageFlip(e) : prevPageFlip(e)}>
                                        ...
                                        {groupOf3.map((contact,idx) => {
                                            return (
                                                <div className='contact'
                                                    ...
                                                    <div className='contact-notes'><span>notes: </span>{contact.notes}</div>
                                                </div>
                                            )
                                        })}
                                    </div>

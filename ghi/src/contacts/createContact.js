  ...
  return (
    <>
      <div
        ...
        onClick={(e) => props.showForm(false)}
      ></div>
              ...
              <>
                ...
                >
                  {specialDays.map((specialday, idx) => {
                    return (
                      <div className="contact" key={specialday.name + idx}>
                        {specialday.name}
                        <div
                  ...
                  {specialDays.length === 0 && "Click here to add special days"}
                </div>
              </>
            )}
            {specialDayShow === 1 && (
              <>
                ...
                />
                <button onClick={(e) => submitSpecialDay()}>
                  Add special day
                </button>
                <button
                  className="form-return-button"
                  onClick={(e) => setSpecialDayShow(0)}
                >
                  return
                </button>
              </>
